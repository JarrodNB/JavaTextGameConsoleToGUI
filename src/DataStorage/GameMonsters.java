...
public class GameMonsters {
    ...
    public static Monster getKraken(Item item, int goldAmount) {
        ...
        try {
            ...
            return new Monster("Kraken", "Huge green sea creature that resides in an ocean moon of Neptune. Frequently terrorizes colonists with its spiky tentacles", 13, 250, goldAmount, inventory);
        } catch (Exception e) {
            System.out.println(e.getMessage());
            return null;
        }
