 ...
 * regular expressions.
 *
 * <p>A <code>MyScanner</code> breaks its input into tokens using a
 ...
 * <blockquote><pre>
      MyScanner sc = new MyScanner(new File("myNumbers"));
 ...
 *<blockquote><pre>
     ...
     MyScanner s = new MyScanner(input).useDelimiter("\\s*fish\\s*");
 ...
 *<blockquote><pre>
     String input = "1 fish 2 fish red fish blue fish";
     MyScanner s = new MyScanner(input);
 ...
 *
 * <p>When a <code>MyScanner</code> is closed, it will close its input source
 * if the source implements the {@link java.io.Closeable} interface.
 *
 * <p>A <code>MyScanner</code> is not safe for multithreaded use without
 * external synchronization.
 *
 * <p>Unless otherwise mentioned, passing a <code>null</code> parameter into
 * any method of a <code>MyScanner</code> will cause a
 ...
 * @since   1.5
 */
public final class MyScanner implements Iterator<String> {
    ...
    // The index into the buffer currently held by the MyScanner
    ...
    private String buildIntegerPatternString() {
        ...
        // MyScanner will do the right thing
     ...
     */
    private MyScanner(Readable source, Pattern pattern) {
        if (source == null)
     ...
     *         does not exist
     */
    public MyScanner(InputStream source, String charsetName) {
     ...
     */
    public MyScanner(ReadableByteChannel source) {
     ...
     *         does not exist
     */
    public MyScanner(ReadableByteChannel source, String charsetName) {
        this(makeReadable(source, charsetName), WHITESPACE_PATTERN);
    }
     ...
     * <code>MyScanner</code>'s underlying <code>Readable</code>. This method
    ...
    /**
     * Returns the <code>Pattern</code> this <code>MyScanner</code> is currently
     ...
     * @return this scanner
     */
    public MyScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public MyScanner useLocale(Locale locale) {
     ...
     */
    public MyScanner useRadix(int radix) {
     ...
     * not successful.
     *
     * <p>The various <code>next</code>methods of <code>MyScanner</code>
    ...
    /**
     * <p>Returns the string representation of this <code>MyScanner</code>. The
     * string representation of a <code>MyScanner</code> contains information
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public MyScanner skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public MyScanner skip(String pattern) {
